...
public class MainPageObject {
    ...
    {
        WebElement element = waitForElementPresent(locator, error_message, 1);
    ...
    public void assertElementPresent(String locator, String error_message)
    {
        ...
        if (amount_of_titles < 1) {
            String default_message = "Element '" + locator + "' not present";
            throw new AssertionError(default_message + " " + error_message);
        }
    }
    ...
    public void swipeUpToFindElement(String locator, String error_message, int max_swipes)
    {
        ...
        while (driver.findElements(by).size() == 0) {
            ...
            if (already_swiped > max_swipes) {
                waitForElementPresent(locator, "cannot find by swipe. \n" + error_message, 0);
                return;
            }
    ...
    public boolean isElementLocatedOnTheScreen(String locator) {
        ...
        if (Platform.getInstance().isMW()){
            ...
            System.out.println("Method isElementLocatedOnTheScreen() does nothing for platform " + Platform.getInstance().getPlatformVar());
        }
